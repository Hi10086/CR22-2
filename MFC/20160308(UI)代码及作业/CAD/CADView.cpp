...
BEGIN_MESSAGE_MAP(CCADView, CView)
	...
	// Standard printing commands
  	ON_UPDATE_COMMAND_UI_RANGE(IDM_LINE, IDM_LINE+100, OnCmdUI)
...
void CCADView::OnLine() 
{
  ...
  //OnMenuItemCheck(IDM_LINE);
  m_nID = IDM_LINE;

  CMainFrame *pFrame = (CMainFrame*)AfxGetMainWnd();
  pFrame->m_wndStatusBar.SetPaneText(0, "hello");
}
...
void CCADView::OnMenuItemCheck(int nID)
{
...
//   
//   pSubMenu->CheckMenuItem(nID, MF_BYCOMMAND | MF_CHECKED);
}

void CCADView::OnCmdUI(CCmdUI* pCmdUI) 
{
  if (pCmdUI->m_nID == m_nID)
