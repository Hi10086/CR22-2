...
void CTest2Dlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT2, m_nEdit);
	//}}AFX_DATA_MAP
}
...
BEGIN_MESSAGE_MAP(CTest2Dlg, CDialog)
	...
	ON_BN_CLICKED(IDC_BTN_SET_TEXT, OnBtnSetText)
	ON_BN_CLICKED(IDC_BUTTON3, OnButton3)
	ON_BN_CLICKED(IDC_BTN_PAST, OnBtnPast)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
void CTest2Dlg::OnBtnSetText() 
{
  GetDlgItem(IDC_EDIT1)->SetWindowText("hell0");

  //ddx数据绑定
  m_strText = "hello world";
  m_nEdit = 3;
  //m_strText.Format("%d %s", 2);
...
void CTest2Dlg::OnButton3() 
{
  ...
  //char* p = m_strText.GetBuffer(0);
  AfxMessageBox(m_strText);
}

void CTest2Dlg::OnBtnPast() 
{
  m_Edit1.Paste();
}
