...
:m_ptBegin(0, 0), m_ptEnd(0, 0), m_ptMove(0, 0)
{
...
void CRectangle::ShapeMove(UINT nFlags, CPoint point)
{
	m_ptBegin = m_ptBegin + (point - m_ptMove);
	m_ptEnd = m_ptEnd + (point - m_ptMove);
	m_ptMove = point;
}
