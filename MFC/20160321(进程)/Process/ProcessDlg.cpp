...
{
	WinExec("D:\\OneKey.exe", SW_SHOWNORMAL);
}

void CProcessDlg::OnButton2() 
{
  ShellExecute(NULL, "edit", "ReadMe.txt", NULL, NULL, SW_SHOWNORMAL);
  //ShellExecute(NULL, "explore", "D:\\", NULL, NULL, SW_SHOWNORMAL);
  //ShellExecute(NULL, "find", "d:\\", NULL, NULL, SW_SHOWNORMAL);
  //ShellExecute(NULL, "print", "ReadMe.txt", NULL, NULL, SW_SHOWNORMAL);
}
...
void CProcessDlg::OnButton3() 
{
  ...
  if (!CreateProcess(NULL, "notepad.exe 1.txt", NULL, NULL, 
               FALSE, 
               NULL,
               NULL, 
               NULL, 
