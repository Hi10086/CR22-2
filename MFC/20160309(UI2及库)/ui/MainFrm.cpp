...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
  ...
  DockControlBar(&m_wndToolBar2);
   ...
   m_Rebar.Create(this);
  m_Rebar.AddBar(&m_wndToolBar1);
   m_Rebar.AddBar(&m_wndToolBar2);

  
  m_DialogBar.Create(this, IDD_DIALOG1,  WS_CHILD | WS_VISIBLE | CBRS_TOP
    | CBRS_GRIPPER | CBRS_TOOLTIPS | CBRS_FLYBY | CBRS_SIZE_DYNAMIC, 0);
